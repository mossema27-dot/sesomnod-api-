...
Restored 2026-04-19: Required by workers/market_scanner_v2.py
which imports MiroFishV3 and MiroFishResult from this module.
Original code preserved intact from scripts/legacy/mirofish_v3_deprecated.py.
"""
...
"""
    ...
    def _generate_warning(self, warnings: List[str]) -> Optional[str]:
